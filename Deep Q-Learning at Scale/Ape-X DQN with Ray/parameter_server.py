# This script includes a parameter server class that serves the optimized Q model weights to actors.
import ray
...
class ParameterServer:
    ...
    def save_eval_weights(self, filename="checkpoints/model_checkpoint"):
